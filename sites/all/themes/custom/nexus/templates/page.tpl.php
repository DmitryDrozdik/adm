...
<header id="masthead" class="site-header container" role="banner">
  <div class="row">
    ...
    $menu = drupal_render($main_menu_tree);
    ?>
    <?php if ($menu): ?>
...
<?php if (theme_get_setting('slideshow_display', 'nexus')): ?>
  ...
  $slide1_url = theme_get_setting('slide1_url', 'nexus');
      ...
      <li>
        ...
        <?php if ($slide1_head || $slide1_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide1_url, array('fragment' => 'content-wrap')); ?>">
              <?php print t('Подробнее'); ?>
            </a>
          </div>
        <?php endif; ?>
      </li>
      <li>
        ...
        <?php if ($slide2_head || $slide2_desc) : ?>
          <div class="flex-caption">
            ...
            <!--            <a class="frmore" href="--><?php //print url($slide2_url); ?><!--"> -->
      ...
      <li>
        ...
        <?php if ($slide3_head || $slide3_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide3_url); ?>">
              <?php print t('Написать'); ?>
            </a>
          </div>
        <?php endif; ?>
      </li>
  ...
  <div id="preface-area">
    <div class="container">
      <div class="row">
        ...
        <div class="preface-block col-sm-<?php print $preface_col; ?>">
